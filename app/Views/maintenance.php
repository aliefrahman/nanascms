...
<body class="bg-gray-50 flex items-center justify-center min-h-screen font-sans">
    <div class="text-center px-6 py-12 max-w-2xl bg-white shadow-xl rounded-2xl border border-gray-100">
        <div class="mb-6 flex justify-center">
            ...
            <svg class="relative top-0 left-3 w-12 h-12 text-amber-500 animate-[spin_3s_linear_infinite]" fill="none"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                class="lucide lucide-settings-icon lucide-settings w-20 h-20 text-amber-500 animate-[spin_3s_linear_infinite]">
                <path
