    ...
    <div class="max-w-xl mx-auto px-6 mt-10 relative z-10 pb-12">
        ...
        <div class="glass-card p-10 md:p-12 rounded-4xl border border-white/5 shadow-2xl relative overflow-hidden">
            ...
            <div class="text-center mb-8">
                <h2 class="font-display font-extrabold text-2xl text-white">Tambah Pengguna</h2>
                <p class="text-xs text-slate-400 mt-2">Daftarkan akun pengguna baru ke sistem nanascms</p>
            </div>
            ...
            <form action="<?= route('/users/store') ?>" method="POST" class="space-y-6">
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="username" name="username" required class="w-full pl-11 pr-5 py-4 rounded-xl bg-dark-bg/60 border border-white/10 focus:border-brand-primary/50 text-white placeholder-slate-600 focus:outline-none transition-colors text-sm" placeholder="Masukkan username unik">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <i data-lucide="user" class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500"></i>
                        <input type="text" id="fullname" name="fullname" class="w-full pl-11 pr-5 py-4 rounded-xl bg-dark-bg/60 border border-white/10 focus:border-brand-primary/50 text-white placeholder-slate-600 focus:outline-none transition-colors text-sm" placeholder="Masukkan nama lengkap">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" required class="w-full pl-11 pr-5 py-4 rounded-xl bg-dark-bg/60 border border-white/10 focus:border-brand-primary/50 text-white placeholder-slate-600 focus:outline-none transition-colors text-sm" placeholder="nama@perusahaan.com">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2">
                        <div class="relative flex-1">
                            ...
                            <input type="url" id="avatar" name="avatar" class="w-full pl-11 pr-5 py-4 rounded-xl bg-dark-bg/60 border border-white/10 focus:border-brand-primary/50 text-white placeholder-slate-600 focus:outline-none transition-colors text-sm" placeholder="https://images.unsplash.com/photo-...">
                        </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password" name="password" required class="w-full pl-11 pr-5 py-4 rounded-xl bg-dark-bg/60 border border-white/10 focus:border-brand-primary/50 text-white placeholder-slate-600 focus:outline-none transition-colors text-sm" placeholder="Min. 6 karakter">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <select id="role_id" name="role_id" required class="w-full pl-11 pr-5 py-4 rounded-xl bg-dark-bg/60 border border-white/10 focus:border-brand-primary/50 text-white focus:outline-none transition-colors text-sm cursor-pointer appearance-none">
                            <option value="" disabled selected class="bg-dark-surface">Pilih Role...</option>
                            <?php foreach ($roles as $r): ?>
                                <option class="bg-dark-surface text-white" value="<?= $r['id'] ?>"><?= htmlspecialchars($r['name']) ?></option>
                            <?php endforeach; ?>
                        </select>
