...
<body
    class="bg-dark-bg text-slate-100 font-sans antialiased min-h-screen flex items-center justify-center relative overflow-hidden px-6 dot-bg py-12">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="glass-card p-10 md:p-12 rounded-3xl border border-white/5 shadow-2xl relative overflow-hidden">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="font-display font-extrabold text-2xl text-white">Buat Akun Baru</h2>
                <p class="text-xs text-slate-400 mt-2">Daftar untuk mengakses sistem dashboard kami</p>
            </div>
            ...
            <form action="<?= route('/register') ?>" method="POST" class="space-y-5">
                ...
                <div class="space-y-2">
                    <label for="email"
                        class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Email</label>
                    <div class="relative">
                        <i data-lucide="mail"
                            class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500"></i>
                ...
                <div class="space-y-2">
                    <label for="role_id" class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Pilih Hak
                        Akses (Role)</label>
                    <div class="relative">
                        <i data-lucide="shield"
                            class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500"></i>
                        <select id="role_id" name="role_id" required
                            class="w-full pl-11 pr-5 py-4 rounded-xl bg-dark-bg/60 border border-white/10 focus:border-brand-primary/50 text-white focus:outline-none transition-colors text-sm cursor-pointer appearance-none">
                            <option value="" disabled selected class="bg-dark-surface">Pilih Role...</option>
                            <?php foreach ($roles as $r): ?>
                                <option class="bg-dark-surface text-white" value="<?= $r['id'] ?>">
            ...
            <div class="mt-8 text-center text-xs text-slate-500">
                ...
                <a href="<?= route('/login') ?>" class="text-brand-primary font-semibold hover:underline ml-1">Masuk
                    sekarang</a>
            </div>
        </div>
    </div>
